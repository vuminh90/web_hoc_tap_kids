...
export default function GameSiteAdmin({ selectedChild }) {
  ...
  return <section className="game-admin-panel">
    ...
    <p className="admin-help">Trong KidsKiosk, website luôn mở trực tiếp cùng cửa sổ để kiểm soát thời gian. Tùy chọn iframe chỉ áp dụng khi dùng trình duyệt web thông thường.</p>
